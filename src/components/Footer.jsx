...
export default function Footer() {
  return (
    <footer className="w-full bg-zinc-950 text-gray-200 py-8 mt-auto">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-2">Email: info@coffeehouse.com</p>
            <p className="text-sm mb-2">Phone: (555) 123-4567</p>
            <p className="text-sm">Address: 123 Coffee Street, Brew City</p>
          </div>
